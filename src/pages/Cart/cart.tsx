        ...
        <div className="container-cart">
          ...
          <div className="formThanhToan">
            <form className="preview" onSubmit={handleSubmit(onSubmit)}>
              ...
              <select id="noi-nhan" name="noi-nhan" className="my-4 text-left" style={{border: '1px solid #219150'}}>
                <option value="Home">Home</option>
                <option value="Company">Company</option>
              </select>
              <p>Specific address</p>
              <div className="mt-1">
                <textarea id="specific-address" name="specific-address" rows={3}  className="px-2 py-1 w-full mt-1 block w-full sm:text-sm rounded-md" style={{border: '1px solid #219150', width:"100%"}} placeholder="Specific address" defaultValue={""} />
              </div>
